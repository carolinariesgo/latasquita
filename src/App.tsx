  ...
  return (
    <div className="bg-black text-white min-h-screen">
      ...
      <section id="hero" className="min-h-screen flex flex-col items-center justify-start pt-24 md:justify-center md:pt-16 pb-0 px-4">
        ...
        {/* 3 location panels */}
        <div className="flex flex-col md:flex-row w-full max-w-5xl border border-white/10">
          {locations.map((loc, i) => (
            <Link
              key={loc.name}
              to={`/${loc.slug}`}
              className={`relative flex-1 flex flex-col items-center justify-center text-center py-4 px-6 md:py-16 md:px-10 group cursor-pointer overflow-hidden
